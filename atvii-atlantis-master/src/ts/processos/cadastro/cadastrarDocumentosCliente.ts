...
import CadastroCpf from "./Documentos/cadastroCpf";
import CadastroPassaporte from "./Documentos/cadastroPassaporte";
import CadastroRg from "./Documentos/cadastroRg";
